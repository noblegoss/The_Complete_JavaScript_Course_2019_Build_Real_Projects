...
//question1:
let bills = [124, 48, 268]; // bills[0] = 124

let tips = [tipCalculator(bills[0]), tipCalculator(bills[1]), tipCalculator(bills[2])];

console.log(tips); // [18.599999999999998, 9.600000000000001, 26.8]

let finalPaidAmount = [ tipCalculator(bills[0]) + bills[0], 
                        tipCalculator(bills[1]) + bills[1], 
                        tipCalculator(bills[2]) + bills[2]];

console.log(finalPaidAmount); // [142.6, 57.6, 294.8]